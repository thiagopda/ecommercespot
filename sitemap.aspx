...
<meta name="Description" content="A sitemap of the Ecommerce Spot site"></head>
<body>
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMjEwNDQyMTMxM2RkLbQTkCMTGBf93wUaeSkEuqq3+n+yZwbuyGeQUoEi9MY=" />
...
<tr>
	<td id="tBody">
			...
			<ul style="line-height: 1.7em;">
				...
				<li><a href="/search-for-shopping-carts.aspx">Search for shopping carts</a></li>
				<li><a href="/all-shopping-carts.aspx">Browse through all shopping cart reviews</a></li>
				<li><a href="/article.aspx">Articles to help set up your online shop</a></li>
				<li><a href="/sitemap.aspx">Sitemap (this page)</a></li>
				<li><a href="/aboutus.aspx">About Us</a></li>
				<li><a href="/aboutus.aspx">About Ecommerce Spot</a></li>
				<li><a href="/privacy.aspx">Privacy Policy</a></li>
				<li><a href="/seo-shopping-cart/">SEO Shopping Cart</a></li>
				<li><a href="/free-shopping-cart.aspx">Free Shopping Cart</a></li>
				<li><a href="/calculator.aspx">Profit per customer calculator</a></li>							
				<li><a href="/write.aspx">Write for us</a></li>		
			</ul>
			<br /><br /><br /><br />	
